...
💡 _Hint_: Disable boot splash to keep the UEFI boot logo. Oppositely, If you want to keep the boot splash image during boot, add the `quiet video=efifb:nobgrt` kernel parameters.
